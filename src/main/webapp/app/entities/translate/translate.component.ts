...
export class TranslateComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.translateService
      ...
      .subscribe(
        (res: HttpResponse<ITranslate[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInTranslates(): void {
    this.eventSubscriber = this.eventManager.subscribe('translateListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITranslate[] | null, headers: HttpHeaders, page: number): void {
