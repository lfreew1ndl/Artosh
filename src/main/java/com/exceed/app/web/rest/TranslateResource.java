...
public class TranslateResource {
    ...
    public ResponseEntity<List<TranslateDTO>> getAllTranslates(Pageable pageable) {
        log.debug("REST request to get a page of Translates");
        Page<TranslateDTO> page = translateService.findAll(pageable);
