...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.exceed.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.exceed.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.exceed.app.domain.User.class.getName());
            createCache(cm, com.exceed.app.domain.Authority.class.getName());
