...
describe('Language e2e test', () => {
  ...
  it('should load Languages', async () => {
    ...
    expect(await languageComponentsPage.getTitle()).to.eq('artoshApp.language.home.title');
  ...
  it('should load create Language page', async () => {
    ...
    expect(await languageUpdatePage.getPageTitle()).to.eq('artoshApp.language.home.createOrEditLabel');
  ...
  it('should delete last Language', async () => {
    ...
    expect(await languageDeleteDialog.getDialogTitle()).to.eq('artoshApp.language.delete.question');
